...
def parse_opt():
    ...
    parser.add_argument('--input_coco_det_json', type=str, default='',
    ...
    parser.add_argument('--paired_percentage', type=float, default=0.01,
                        help='The percentage of the training set, where the images and sentences are paired.')
    parser.add_argument('--random_seed', type=int, default=0,
                        help='To guarantee that the sample results are the same.')
    parser.add_argument('--language_pretrain_epoch', type=int, default=0,
                        help='To pretrain the language model.')
    parser.add_argument('--paired_train_epoch', type=int, default=0,
                        help='To train the model with paired images.')
    parser.add_argument('--number_of_models', type=int, default=3,
                        help='The number of multi-models.')
    parser.add_argument('--alpha', type=float, default=0.999,
                        help='The ensembling momentum.')
    parser.add_argument('--hyper_parameter_lambda_x', type=float, default=1,
                        help='The hyper parameter for lambda to balance the unsupervised information.')
    parser.add_argument('--hyper_parameter_lambda_y', type=float, default=1,
                        help='The hyper parameter for lambda to balance the unsupervised information.')
    parser.add_argument('--std_pseudo_visual_feature', type=float, default=1,
                        help='The hyper parameter for the std of pseudo visual feature.')
    parser.add_argument('--inner_iteration', type=float, default=100,
                        help='The number of the inner iteration.')
